...
using uart1_tx = Gpio<Port::_A, Pin::_9, Mode::AlternatePushPull, Speed::VeryHigh, Pullup::None>;
using uart1_rx = Gpio<Port::_A, Pin::_10, Mode::Input>;

using uart2_tx = Gpio<Port::_A, Pin::_2, Mode::AlternatePushPull, Speed::VeryHigh, Pullup::None>;
using uart2_rx = Gpio<Port::_A, Pin::_3, Mode::Input>;
}
