function(stm32_util_create_family_targets FAMILY)
    ...
    if(NOT (TARGET STM32::${FAMILY}${CORE_C}))
        ...
        target_compile_options(STM32::${FAMILY}${CORE_C} INTERFACE
            ...
            -mthumb -mabi=aapcs -Wall -ffunction-sections -fdata-sections -fno-strict-aliasing -fno-builtin -ffast-math -Os
            $<$<CONFIG:Debug>:-Og>
            $<$<CONFIG:Release>:-Os>
        )
        target_link_options(STM32::${FAMILY}${CORE_C} INTERFACE
            #--sysroot="${TOOLCHAIN_SYSROOT}"
            -mthumb -mabi=aapcs -Wl,--gc-sections,--print-memory-usage,-Map=${PROJECT_BINARY_DIR}/${PROJECT_NAME}.map -Os
            $<$<CONFIG:Debug>:-Og>
            $<$<CONFIG:Release>:-Os># -s>
        )
